...
<body>
    ...
    <script>
        var USUARIO_LOGADO = 'true' if logado else 'false';
        ...
        function buscarCliente() {{
            ...
            // SIMULAÇÃO - Cliente encontrado (troque para false para testar)
            ...
            fetch('/api/simular?cep=' + encodeURIComponent(cep) + '&peso=' + peso + '&modalidade=' + modalidade + '&valor_nf=' + valorNF)
                ...
                .then(function(data) {{
                    if (data.success) {{
                        ...
                        var areaBotoes = document.getElementById('areaBotoes');
                ...
                .catch(function(error) {{
                    ...
                    resultado.innerHTML = 
                        '<div class="alert alert-warning">' +
                            '<i class="bi bi-exclamation-triangle"></i> Erro ao simular frete. Tente novamente.' +
                        '</div>';
                }});
        }}
        ...
        function gerarBotoes() {{
            var logado = USUARIO_LOGADO === 'true';
